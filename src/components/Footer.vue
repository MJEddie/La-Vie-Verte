...
<template>
  <footer class="w-100">
      <nav class="navbar footer">
          <div class="container justify-content-center">
              <ul class="nav justify-content-between">
                  ...
                  <li class="nav-item">
                      <a href="#" target="_blank" class="nav-link">個人資料保護方針</a></li>
      ...
      <div class="logo d-flex justify-content-center">
        <a href="#">
          <img src="../assets/images/flogo.svg" alt="">
        </a>
      </div>
      <p class="copyright text-center mb-0">NICK &copy; 2021 COPYRIGHT &emsp;本網站僅做為個人學習使用，非商業用途</p>
  </footer>
</template>
